...
contract File
{
  ...
  string public FileId; // identifier for the file in OneDrive
  string public ContentType; // file type as defined by OneDrive
  string public Etag; // as defined by OneDrive
  string public UploadDateTime; // MM/DD/YY HH:MM:SS in UTC
